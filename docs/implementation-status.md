...
2. Add deterministic evidence replay, bookmarks and sanitized export on top of the implemented
   Mission Map filters and packaged research-brief showcase.
