...
2. Continue the accepted
   ...
   additional Pack resource kinds/upgrades, and template-driven Agent Appointments, Goals,
   Operations, Memory Policies, and budgets for the installed market-intelligence studio.
