...
2. Add scalable large-graph navigation and optional server-shared replay bookmarks only when
   operators need to collaborate on high-volume Task histories.
